...
ActiveRecord::Schema[7.1].define(version: 2024_03_10_014809) do
  ...
  create_table "infections", force: :cascade do |t|
    ...
    t.bigint "infected_user_id"
    t.index ["infected_user_id"], name: "index_infections_on_infected_user_id"
